...
CREDIT: Adapted from John Huang script: http://www.sqlnotes.info/2011/10/03/a-procedure-for-creating-database-snapshot/
USAGE:
...
CREATE PROCEDURE p_CreateTimeStampedDatabaseSnapshot (@SourceDatabaseName SYSNAME)
AS
BEGIN
	...
	-- Can't read the sys tables of the database to get the physical filenames, as mirrored databases are unreadable! available in the master database though..
